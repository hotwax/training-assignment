...
class Demo {
  public static void main(String ar[]) throws Exception {
    ...
    BufferedReader br = new BufferedReader(new FileReader("E:\\Work\\java work\\Module2\\src\\word_count\\input.txt"));
    ...
    BufferedReader br1 = new BufferedReader(new FileReader("E:\\Work\\java work\\Module2\\src\\word_count\\words.txt"));
