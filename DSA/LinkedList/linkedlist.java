...
public class linkedlist {
	...
	// Creating search method to search the element and show the index at which the
	// data is present
	void search(int val) {
		LinkedlistNode temp = head;
		int counter = 0;
		while (temp != null) {
			// when we found user input value in a linkedlist then simply print the index at
				...
				try {
					switch (ch) {
						...
						case 2:
							...
							link.insertattail(input_value1);
							link.display();
							break;
