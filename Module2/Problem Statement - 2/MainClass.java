...
class Employee {
    ...
    public String toString() {
        return "Employee{" +
                ...
                ", age=" + age +
                ", dateOfBirth='" + MainClass.simpleDateFormat.format(dateOfBirth) + '\'' +
                '}';
    }
}
// Main Class
public class MainClass{
    ...
    private static void writeFile() {
        try {
            ...
            for(Employee emp :employeeList){
                writer.write(emp.getEmpID()+","+emp.getName()+","+emp.getemailAddress()+","+emp.getAge()+","+MainClass.simpleDateFormat.format(emp.getDateOfBirth())+"\n");
            }
            writer.close();
        } catch (IOException e) {
            throw new RuntimeException(e);
