...
// Here i use Quadratic Probing
// In quadratic probing we are lookling for i²th slot if i th slot is not empty
class Node
{
public:
    int key;
...
public:
    ...
    // To handle Collisions I used Quadratic probing
    void Insert(int key, int value)
    {
        ...
        //  TO HANDLE COLLISION HERE I USE
        //        "QUADRATIC PROBING"
