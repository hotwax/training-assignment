...
function serialization(filename) {
  ...
  const student = [
    new Student('Rishabh', '1990-01-01', new Address("Indore", "MP", 452001, "India")),
    new Student('Sarthak', '1992-02-02', new Address("Bhopal", "MP", 452045, "India")),
    new Student('Vaibhav', '2001-01-01', new Address("Ujjain", "MP", 452076, "India")),
    new Student('Nayan', '2001-01-01', new Address("Dewas", "MP", 452087, "India"))
  ];
...
function enterChoice() {
  // displaying menu 
  console.log('\nchoose option:');
  console.log('1. For Serialize file');
  console.log('2. For Deserialize file');
  console.log('3. Exit');
