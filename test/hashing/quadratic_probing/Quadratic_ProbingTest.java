 ...
 * @author Dhruv
 */
public class Quadratic_ProbingTest {
    
    @Test
    public void testingMyCode() {
        System.out.println("testing..........");
        Quadratic_Probing map=new Quadratic_Probing(17,40);
        map.put(10, 100);
        map.put(21, 200);
        map.put(32, 300);
        map.put(43, 400);
        ...
        assertEquals(2, map.getTotalCollisions());
        ...
        map.traverse();
        map.put(38, 2800);
        assertEquals(3, map.getTotalCollisions());
